...
import com.shoe.config.VnpayConfig;
...
public class OrderController {
	...
	@GetMapping("/kingsman/order/checkout")
...
//			List<Vouchers> voucher=voucherService.findAll();
	...
	@PostMapping("/kingsman/order/checkout")
	@ResponseBody
...
//		Orders order = (Orders) session.getAttribute("OrderganNhat");
	...
	public String detail(@PathVariable("id") Integer id,Model model){
	 ...
	 public void sendSimpleEmail(String email,Orders order) {
	        ...
	        message.setTo(email);
	        message.setSubject("Đặt hàng thành công tại kingsman.com");
	        message.setText("Cảm ơn bạn đã mua hàng tại kingsman.com.\r\n"
	        		+ "Mã hóa đơn của bạn là: "+order.getOrderId()+"\r\n"	
	        		+ "Vui lòng click vào đường link: http://localhost:8080/kingsman/account/history/detail/"+order.getOrderId()+ " để xem chi tiết hóa đơn.\r\n"
