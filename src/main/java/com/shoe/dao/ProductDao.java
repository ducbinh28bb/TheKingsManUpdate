...
public interface ProductDao extends JpaRepository<Product, Integer>{
	...
	@Query(value = "SELECT brand_id,product.category_id,product.create_date,description,image,product.name,\r\n"
			+ "origin,product.price,product.product_id,product.gender,product.toe_id,product.design_id,product.size_id,product.height_id,product.material_id,product.update_date,product.quantity,product.status\r\n"
	...
	@Query(value = "SELECT brand_id,category_id,product.create_date,description,image,name,\r\n"
			+ "origin,product.price,product.product_id,product.gender,product.toe_id,product.design_id,product.size_id,product.height_id,product.material_id,product.update_date,product.quantity,product.status, count(order_detail.product_id) as 'tongspmua'\r\n"
	...
	@Query(value = "select p from Product p where height =?1")
	Page<Product> selectAllHeight(String height,Pageable pageable);
	...
	@Query(value="select * from product where status = 1 and material_id = ?1", nativeQuery = true)
	Page<Product> getProductByMaterial(Long gender, Pageable pageable);
