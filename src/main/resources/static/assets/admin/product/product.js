app.controller("product-ctrl", function ($scope, $http) {
    ...
    $scope.initialize = function () {
        ...
        //load toe
        $http.get("/rest/toe/getAllStatus").then(resp => {
            $scope.toe = resp.data;
        })
        ...
        //load height
        $http.get("/rest/height/getAllStatus").then(resp => {
            $scope.height = resp.data;
        })
        
        //load design
        $http.get("/rest/design/getAllStatus").then(resp => {
            $scope.design = resp.data;
        })
        productId = "";
    }
    //khởi đầu
...
$scope.reset1 = function () {
    ...
    $scope.create = function () { 
		...
		var heightSelect = document.getElementById("heightSelect").value;
		if(heightSelect =="" || heightSelect ==null){
		...
		var toeSelect = document.getElementById("toeSelect").value;
		if(toeSelect =="" || toeSelect ==null){
			alert("Mũi giày không được để trống");
			return false;
		}
		...
		var designSelect = document.getElementById("designSelect").value;
		if(designSelect =="" || designSelect ==null){
			alert("Kiểu dáng sản phẩm không được để trống");
			return false;
		} 
